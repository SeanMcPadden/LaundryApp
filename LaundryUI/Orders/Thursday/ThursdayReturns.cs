...
{
    public partial class ThursdayReturns : Form
    {

        public List<DayModel> returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Thursday();
        ...
        {
            returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Thursday();
        }
        ...
        private void viewThursdaysReturnsButton_Click(object sender, EventArgs e)
        {
            ConfirmDay = "Thursday";
            this.Hide();
