...
{
    public partial class ThursdayKitchenwear : Form
    {
        public static string ConfirmDay = "";
        public List<DayModel> ordersNotYetPlaced = GlobalConfig.Connection.GetDay_Thursday();
        private List<DayModel> ordersPlaced = new List<DayModel>();
        public static string SetValueForRestaurant = "";

        public ThursdayKitchenwear()
        {
            InitializeComponent();
        ...
        {
            ordersNotYetPlaced = GlobalConfig.Connection.GetDay_Thursday();
        }
        ...
        private void viewThursdaysOrderButton_Click(object sender, EventArgs e)
        {
            ConfirmDay = "Thursday";
            this.Hide();
