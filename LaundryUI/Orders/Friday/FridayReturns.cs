...
{
    public partial class FridayReturns : Form
    {

        public List<DayModel> returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Friday();
        ...
        {
            returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Friday();
        }
        ...
        private void viewFridaysReturnsButton_Click(object sender, EventArgs e)
        {
            ConfirmDay = "Friday";
            this.Hide();
