...
{
    public partial class TuesdaysOrders : Form
    {
        public List<DayModel> ordersNotYetPlaced = GlobalConfig.Connection.GetDay_Tuesday();
        ...
        {
            ordersNotYetPlaced = GlobalConfig.Connection.GetDay_Tuesday();
        }
        ...
        private void viewTuesdaysOrdersButton_Click(object sender, EventArgs e)
        {
            ConfirmDay = "Tuesday";
            this.Hide();
