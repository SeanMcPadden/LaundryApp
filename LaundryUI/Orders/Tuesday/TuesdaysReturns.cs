...
{
    public partial class TuesdaysReturns : Form
    {

        public List<DayModel> returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Tuesday();
        ...
        {
            returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Tuesday();
        }
        ...
        private void viewTuesdaysReturnsButton_Click(object sender, EventArgs e)
        {
            ConfirmDay = "Tuesday";
            this.Hide();
