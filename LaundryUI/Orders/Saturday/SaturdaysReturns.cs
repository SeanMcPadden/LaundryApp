...
{
    public partial class SaturdaysReturns : Form
    {

        public List<DayModel> returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Saturday();
        ...
        {
            returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Saturday();
        }
