...
{
    public partial class WednesdayReturns : Form
    {

        public List<DayModel> returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Wednesday();
        ...
        {
            returnsNotYetProcessed = GlobalConfig.Connection.GetDay_Wednesday();
        }
        ...
        private void viewWednesdaysReturnsButton_Click(object sender, EventArgs e)
        {
            ConfirmDay = "Wednesday";
            this.Hide();
